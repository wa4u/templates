			...
			<div class="col-sm-4 col-lg-4 text-center">
					...
					<div class="col-xs-6 col-sm-3 col-lg-3 small-margin-top small-margin-bottom"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, tep_get_all_get_params()) . '" class="btn btn-sm cursor-pointer small-margin-right btn-success" >' . IMAGE_BUTTON_BACK . '</a>'; ?></div>
							...
							//wishlist button
							  ...
							  echo '<div class="col-xs-6 col-sm-3 col-lg-3 small-margin-top small-margin-bottom"><a href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action','cPath','products_id')) . 'action=buy_now&products_id=' . $product_info['products_id'] . '&cPath=' . tep_get_product_path($product_info['products_id'])) . '">' . tep_template_image_button('button_in_cart.gif', IMAGE_BUTTON_IN_CART) . '</a></div>';
							echo '<div class="col-xs-6 col-sm-3 col-lg-3 small-margin-top small-margin-bottom"><form name="wishlist_quantity" method="post" action="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=add_wishlist', 'NONSSL') . '">';
							...
							?>
					<div class="col-xs-6 col-sm-3 col-lg-3 small-margin-top small-margin-bottom"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, tep_get_all_get_params()) . '" class="btn btn-sm cursor-pointer small-margin-right btn-success">' . IMAGE_BUTTON_WRITE_REVIEW . '</a>'; ?></div>
					<div class="clearfix"></div>
					<?php
