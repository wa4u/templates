  ...
  switch($show){
    ...
    case 'logo':
      if (tep_not_null($affiliate_branding['affiliate_cobrand_image']) && file_exists(DIR_FS_CATALOG . DIR_WS_IMAGES . 'affiliate_cobrand/' . $affiliate_branding['affiliate_cobrand_image'])) {
        ...
        $store_info = '<a href="' . $brand_url . '">' . tep_image(DIR_WS_IMAGES . 'logo/' . $site_brand_info['store_brand_image'], '', '', '', 'class="small-margin-right margin-top img-logo-responsive"') . '</a>';
      } elseif (tep_not_null($site_brand_info['store_brand_name'])) {
        $store_info = '<a class="branding_name" href="' . $brand_url . '"><h1>' . $site_brand_info['store_brand_name'] . '</h1></a>';
      } else {
        $store_info = '<a class="branding_name" href="' . $brand_url . '"><h1 class="margin-left">' . STORE_NAME .'</h1></a>';
      }
      break;
    ...
    case 'slogan':
      if (tep_not_null($affiliate_branding['affiliate_cobrand_slogan'])) {
        $store_info = '<p class="slogan clear-both small-margin-top margin-left hide-on-mobile">' . $affiliate_branding['affiliate_cobrand_slogan'] . '</p>';
      } elseif (tep_not_null($site_brand_info['store_brand_slogan']) ) {
        $store_info = '<p class="slogan clear-both margin-top margin-left hide-on-mobile">' . $site_brand_info['store_brand_slogan'] . '</p>';
      }
      break;
