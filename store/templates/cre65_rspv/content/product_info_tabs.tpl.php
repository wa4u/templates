<style type="text/css">
 /* Kiran added */
.table-borderless table, .table-borderless td, .table-borderless th, .table-borderless tbody tr td {
...
// RCI code eof
echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_PRODUCT_INFO, tep_get_all_get_params(array('action', 'products_id', 'id')) . 'action=add_product' . '&' . $params), 'post', 'enctype="multipart/form-data" class="form-inline"'); ?>
...
<div class="col-sm-12 col-lg-12 clearfix margin-top" ><!-- h1 class="no-margin-top"><?php //echo $product_info['products_name']; ?></h1 --></div>
   ...
   <div class="col-sm-4 product-left">
		...
		<?php
   	  ...
   	  <!-- Megnor Cloud-Zoom Image Effect Start -->
   	  	<div class="image"><a title="<?php echo $product_info['products_name'] ;?>" href="<?php echo DIR_WS_IMAGES . $new_image ;?>" class="thumbnail fancybox"><?php echo tep_image(DIR_WS_IMAGES . $new_image, $product_info['products_name'],  $image_height,'', 'class="img-responsive"');?></a></div>
    ...
    <h1 class="no-margin-top"><?php echo $product_info['products_name']; ?></h1>
...
<script type="text/javascript">
    ...
    <br class="small-margin-top small-margin-bottom">
			<!-- attributes -->
	            <?php
...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#product_info"><?php echo TEXT_TAB_PRODUCT_INFO;?></a></li>
    <?php
    ...
    ?>
  <li><a data-toggle="tab" href="#products_tab_2"><?php echo tep_not_null(TEXT_PRODUCTS_TAB_2_TITLE ) ? TEXT_PRODUCTS_TAB_2_TITLE : ' &nbsp; '; ?></a></li>
  <?php
        }
        if(tep_not_null($product_tab['products_tab_3'])){
    ?>
  <li><a data-toggle="tab" href="#products_tab_3"><?php echo tep_not_null(TEXT_PRODUCTS_TAB_3_TITLE ) ? TEXT_PRODUCTS_TAB_3_TITLE : ' &nbsp; '; ?></a></li>
  <?php
        }
        if(tep_not_null($product_tab['products_tab_4'])){
    ?>
  <li><a data-toggle="tab" href="#products_tab_4"><?php echo tep_not_null(TEXT_PRODUCTS_TAB_4_TITLE ) ? TEXT_PRODUCTS_TAB_4_TITLE : ' &nbsp; '; ?></a></li>
  <?php
        }
  }
            ...
            ?>
  <li><a data-toggle="tab" href="#products_extra_fields"><?php echo TEXT_TAB_PRODUCT_EXTRA_FIELDS;?></a></li>
  <?php
            }
            ...
            ?>
  <li><a data-toggle="tab" href="#products_manufacturer"><?php echo TEXT_TAB_PRODUCT_EXTRA_FIELDS;?></a></li>
  <?php
            }
            ...
            ?>
  <li><a data-toggle="tab" href="#products_reviews"><?php echo TEXT_TAB_PRODUCT_REVIEWS;?></a></li>
  <?php
            }
  ?>
  <li><a data-toggle="tab" href="#products_extra_info"><?php echo TEXT_TAB_PRODUCT_EXTRA_INFO;?></a></li>
  <?php
  ...
  ?>
    <li><a data-toggle="tab" href="#products_tab_relatedfiles"><?php echo TEXT_RELATED_FILES;?></a></li>
    <?php 
  }
}
  ?>
...
<div class="tab-content" style="margin-top:20px;">
  ...
  <?php
   ...
   if ( tep_db_num_rows($extra_fields_query) > 0 ) {
  ?>
  <div id="products_extra_fields" class="tab-pane fade">
  <p>
                <?php
  ...
  <?php
    ...
    if (tep_db_num_rows($product_manufacturer_query)) {
  ?>
    <div id="products_manufacturer" class="tab-pane fade">
                  <?php
  ...
  <?php
    ...
    if (tep_db_num_rows($reviews_query) > 0) {
  ?>
  <div id="products_reviews" class="tab-pane fade">
                  <?php
               while ($reviews = tep_db_fetch_array($reviews_query)) {
                echo '<span class="smallText">' . sprintf(TEXT_REVIEW_BY, tep_output_string_protected($reviews['customers_name'])) . '</span>';
             ...
             if(tep_db_num_rows($reviews_query) == PRODUCT_INFO_TAB_NUM_REVIEWS ) { echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS, tep_get_all_get_params() . $params) . '">' . tep_template_image_button('button_reviews.gif', IMAGE_BUTTON_REVIEWS) . '</a>'; } 
            ?>
            </div>
  <?php
    }
  ?>
  <div id="products_extra_info" class="tab-pane fade">
                  <?php
                     if (tep_not_null($product_info['products_url'])) {
  ...
  if($num_files_related > 0) {
  ?>
  <div id="products_tab_relatedfiles" class="tab-pane fade">
  <table cellpadding="0" cellspacing="1" border="0" width = "100%" class="table table-striped table-borderless">
  <tr>
  <th><?php    echo TEXT_DOWNLOAD_FILE;?></th>
  <th><?php echo TEXT_MORE_INFO;?></th>
  </tr>
  <?php
    ...
    while($listing_array=tep_db_fetch_array($sql_query)) {
      ...
      echo '<tr><td>' . $download_criteria . '</td><td><a href="'.tep_href_link(FILENAME_FILE_DETAIL,'file_id='.$listing_array['library_id']).'">' . tep_image('images/file_icons/' . $listing_array['icon_small']) . ' &nbsp; ' .$listing_array['files_descriptive_name'].'</a></td></tr>';
...
<div class="clearfix"></div>
<div class="col-sm-12 col-lg-12">
<?php echo $cre_RCI->get('productinfotabs', 'bottom');?>
  <?php
