...
<!-- whos_online //-->
     <div class="well">
      <div class="box-header small-margin-bottom small-margin-left"  style="color:#333333;font-size:13px;font-weight:bold;border-bottom:1px text-transform:capitalize;" ><?php echo  BOX_HEADING_WHOS_ONLINE ; ?></div><br>
   <?php
