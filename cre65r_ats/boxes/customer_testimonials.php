...
?>
  <div class="well">
      ...
      <ul class="box-customer_testimonials-ul list-unstyled list-indent-large">
            <?php
              $testimonial = substr($random_testimonial['testimonials_html_text'], 0, 100);

              echo '<a href="' . tep_href_link(FILENAME_CUSTOMER_TESTIMONIALS, 'testimonial_id=' . $random_testimonial['testimonials_id']) . '"><b><center>' . $testimonial_titulo . '</center></b></li>';
              echo  '<li>' . strip_tags($testimonial) . '...<br><br><b>' . TEXT_READ_MORE . '</b></a><br><br></li>';
              echo '<li><b>'.$random_testimonial['testimonials_name'].'</li>';
            ?>
      </ul>
      </div>
      <?php
