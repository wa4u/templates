...
?>
        ...
        <td align="right"><input type = "hidden" name = "htxt_flag" value = "0" ><?php echo tep_template_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE,"onclick='document.affiliate_details.htxt_flag.value=1';"); ?></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
