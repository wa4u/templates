...
<?php
    echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_1'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
?>
...
<div class="product-block">
<?php
    echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_sm_1'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_1'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
?>
</div>
</div>
<?php
...
<div class="product-block">
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_1'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_xl_1'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
...
<div class="product-block">
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_2'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_2'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_2'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_xl_2'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
</div>
</div>
<?php
...
<div class="product-block">
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_2'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_2'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_2'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_2'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
</div>
</div>
<?php
...
<div  class="7 product-block "  >
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_sm_3'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_sm_3'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_sm_3'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_3'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
</div>
</div>
<?php
...
<div class="8 product-block "  >
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_3'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_sm_3'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_3'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_3'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
...
<div class="9 product-block "  >
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_3'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_3'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_3'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_xl_3'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
...
<div class="10 product-block "  >
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_sm_4'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_sm_4'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_sm_4'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_4'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
</div>
</div>
<?php
...
<div class="11 product-block "  >
  ...
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_4'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_4'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_4'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_sm_4'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
...
<div class="12 product-block "  >
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_4'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_4'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_4'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_xl_4'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
</div>
</div>
<?php
...
<div class="13 product-block "  >
  <?php
      echo '<a data-zoom-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_5'].'" data-image="'.DIR_WS_IMAGES . $product_info['products_image_xl_5'].'" class="thumbnail elevatezoom-gallery fancybox" title="'.$product_info['products_name'].'" href="'.DIR_WS_IMAGES . $product_info['products_image_xl_5'].'">'.tep_image(DIR_WS_IMAGES . $product_info['products_image_xl_5'], $product_info['products_name'], '', '','class="img-responsive"').'</a>';
  ?>
