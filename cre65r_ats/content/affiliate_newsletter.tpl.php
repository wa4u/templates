...
echo $cre_RCI->get('affiliatenewsletter', 'top');
// RCI code eof

 echo tep_draw_form('account_newsletter', tep_href_link(FILENAME_AFFILIATE_NEWSLETTER, '', 'SSL')) . tep_draw_hidden_field('action', 'process');
?>
...
<?php
// RCI code start
echo $cre_RCI->get('affiliatenewsletter', 'menu');
// RCI code eof
// BOF: Added for template MOD
if (MAIN_TABLE_BORDER == 'yes'){
          ...
          <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
            <tr class="infoBoxContents">
              <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                <tr>
                  <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_CENTRAL, '', 'SSL') . '">' . tep_template_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
...
<?php
// RCI code start
echo $cre_RCI->get('affiliatenewsletter', 'bottom');
