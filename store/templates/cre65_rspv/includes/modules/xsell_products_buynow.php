...
echo '<h3>' . TEXT_XSELL_PRODUCTS . '</h3>';
      ...
      while ($xsell = tep_db_fetch_array($xsell_query)) {
       ...
       echo  '<div class="col-sm-4 col-lg-4 text-center" ><div class="thumbnail small-padding-top small-padding-bottom small-padding-left small-padding-right"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $xsell['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $xsell['products_image'], $xsell['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $xsell['products_id']) . '">' . $xsell['products_name'] .'</a><br>' . cre_products_blurb($xsell['products_id']) . $xsell_price. $s_buy_now. '</div></div>';
