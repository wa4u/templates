...
<!-- D featured_products_mainpage //-->
    <div class="well well-sm">
        <strong><?php echo TABLE_HEADING_FEATURED_PRODUCTS;?></strong>
    </div>
...
?>
        <div class="item col-xs-12 col-sm-6 col-md-3 col-lg-4">
            <div class="thumbnail">
                <a href="<?php echo tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $mainpage_featured_products['products_id']);?>"><?php echo tep_image(DIR_WS_IMAGES . $mainpage_featured_products['products_image'], $mainpage_featured_products['products_name'], 400, 250, 'class="group list-group-image"');?></a>
                <div class="caption">
                    <h4 class="group inner list-group-item-heading"><?php echo $mainpage_featured_products['products_name'];?></h4>
                    <p class="group inner list-group-item-text"><?php echo ((INSTALLED_VERSION_TYPE == 'B2B' ||  INSTALLED_VERSION_TYPE == 'Pro')? cre_products_blurb($mainpage_featured_products['products_id']): cre_product_short_description_template($mainpage_featured_products['products_id']));?></p>
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <p class="lead"><?php echo $products_price_2bb;?></p>
                        </div>
                        <div class="col-xs-12 col-md-6">
                            <a class="btn btn-success" href="<?php echo tep_href_link(FILENAME_PRODUCT_INFO, 'action=buy_now&amp;products_id=' . $mainpage_featured_products['products_id']);?>">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
