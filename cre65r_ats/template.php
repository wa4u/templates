...
*/
  define('TEMPLATE_NAME_REF', 'cre65r_ats');
  ...
  define('DIR_FS_TEMPLATE_BOXES', DIR_FS_TEMPLATES . 'cre65r_ats/boxes/');
  define('DIR_FS_TEMPLATE_MAINPAGES', DIR_FS_TEMPLATES . 'cre65r_ats/mainpage_modules/');
  define('DIR_WS_TEMPLATE_IMAGES', DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/');

  //which files to use
  define('TEMPLATE_BOX_TPL', DIR_WS_TEMPLATES . 'cre65r_ats/boxes.tpl.php');
  define('TEMPLATE_HTML_OUT', DIR_WS_TEMPLATES . 'cre65r_ats/extra_html_output.php' );
