<?php
require(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/includes/cds_menu.php');
/*
    ...
    <div class="pull-right margin-right">
      ...
      <ul class="cart-menu nav-item pull-right no-margin-bottom">
        <li class="dropdown">
          ...
          <?php include('templates/cre65_rspv/includes/header-lang-curr.php');?>
    </div>
   </div>
  </div>
   ...
   <div class="row no-margin-bottom">
      <div class="col-xs-12 col-sm-6 col-lg-6">
         <?php echo cre_site_branding_rspv('logo') . cre_site_branding_rspv('slogan'); ?>
			...
			<div class="col-xs-5 col-sm-6 col-lg-6 branding-sps pull-right margin-top">
    ...
    <div class="navbar navbar-inverse small-margin-bottom mobile-expand" role="navigation">
        ...
        <div class="navbar-header">
         ...
         <form role="form" class="form-inline" name="mobile-search" id="mobile-search" action="<?php echo tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, null, 'SSL', false); ?>" method="get">
            ...
            <button class="btn btn-sm cursor-pointer small-margin-right<?php echo (($cart->count_contents() > 0) ? ' btn-success' : ' btn-default disabled'); ?>" type="button" onclick="window.location.href='<?php echo tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'); ?>'">Checkout</button>
              <i class="fa fa-search navbar-search-icon cursor-pointer" onclick="window.location.href='<?php echo tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'SSL'); ?>'"></i>
          ...
          <div class="mobile-portrait-search-input-cover"></div>
			...
			<div class="no-margin-bottom">
          	...
          	<ul class="nav navbar-nav col-lg-8 z-index-1">
            <?php 
            generate_cds_menu(309);
            /*
		  ...
		  <div class="text-right small-margin-top small-margin-bottom col-lg-4" style="margin-top: 6px !important;">
			   <form role="form" class="form-inline hide-on-mobile" name="search" id="search" action="<?php echo tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, null, 'SSL', false); ?>" method="get">
			    <span class="text-right">
            <span class="text-right">
              <?php
