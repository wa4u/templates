...
echo BOX_TEXT_TELL_A_FRIEND;
            ...
            $info_box_contents[] = array('form' => tep_draw_form('tell_a_friend_article', tep_href_link(FILENAME_TELL_A_FRIEND_ARTICLE, '', 'NONSSL', false), 'get'),
                                          'align' => 'left',
                                          'text' => '<br>'. TEXT_TELL_A_FRIEND . '<div style="padding-top:10px;">' . tep_draw_input_field('to_email_address', '', 'size="40" maxlength="40" style="width: ' . (BOX_WIDTH-30) . 'px"') .  '<div style="padding-top:10px;">' . tep_draw_hidden_field('articles_id', $_GET['articles_id']) . tep_hide_session_id() . tep_template_image_submit('button_tell_a_friend.gif', BOX_HEADING_TELL_A_FRIEND) );
